...
const dbPackageDir = path.join(appDir, "../../packages/database");
...
try {
  ...
  console.log("Continuing with deployment despite migration issues...");
}
...
if (fs.existsSync(prismaDir)) {
  const destPrismaDir = path.join(deployDir, "packages/database/prisma");
