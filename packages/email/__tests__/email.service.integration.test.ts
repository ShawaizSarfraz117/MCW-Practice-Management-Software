...
describe("EmailService Integration Tests", () => {
  ...
  // Skip these tests in CI if Gmail credentials are not available
  ...
  conditionalTest(
    "should verify Gmail SMTP connection",
    async () => {
  ...
  conditionalTest(
    "should send a simple test email",
    async () => {
  ...
  conditionalTest(
    "should send email with attachment",
    async () => {
    ...
    20000,
  ); // 20 second timeout for email with attachment
  ...
  conditionalTest("should validate attachment size", async () => {
