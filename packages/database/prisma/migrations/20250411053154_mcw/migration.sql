...
CREATE TABLE "Appointment" (
    ...
    CONSTRAINT "Appointment_clinician_id_fkey" FOREIGN KEY ("clinician_id") REFERENCES "Clinician" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    ...
    CONSTRAINT "Appointment_recurring_appointment_id_fkey" FOREIGN KEY ("recurring_appointment_id") REFERENCES "Appointment" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "AppointmentTag" (
    ...
    CONSTRAINT "AppointmentTag_appointment_id_fkey" FOREIGN KEY ("appointment_id") REFERENCES "Appointment" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "AppointmentTag_tag_id_fkey" FOREIGN KEY ("tag_id") REFERENCES "Tag" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Audit" (
    ...
    CONSTRAINT "Audit_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "Client" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "Client" (
    ...
    "referred_by" TEXT,
    CONSTRAINT "Client_primary_clinician_id_fkey" FOREIGN KEY ("primary_clinician_id") REFERENCES "Clinician" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "Client_primary_location_id_fkey" FOREIGN KEY ("primary_location_id") REFERENCES "Location" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "ClientGroupMembership" (
    ...
    CONSTRAINT "ClientGroupMembership_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "Client" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "ClientGroupMembership_client_group_id_fkey" FOREIGN KEY ("client_group_id") REFERENCES "ClientGroup" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "ClinicianClient" (
    ...
    CONSTRAINT "ClinicianClient_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "Client" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "ClinicianClient_clinician_id_fkey" FOREIGN KEY ("clinician_id") REFERENCES "Clinician" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "CreditCard" (
    ...
    "token" TEXT,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "CreditCard_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "Client" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Invoice" (
    ...
    CONSTRAINT "Invoice_client_group_id_fkey" FOREIGN KEY ("client_group_id") REFERENCES "ClientGroup" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "Invoice_clinician_id_fkey" FOREIGN KEY ("clinician_id") REFERENCES "Clinician" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Payment" (
    ...
    "status" TEXT NOT NULL,
    "response" TEXT,
    CONSTRAINT "Payment_credit_card_id_fkey" FOREIGN KEY ("credit_card_id") REFERENCES "CreditCard" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "SurveyAnswers" (
    ...
    "is_signed" BOOLEAN,
    "is_locked" BOOLEAN,
    CONSTRAINT "SurveyAnswers_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "Client" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "SurveyAnswers_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "SurveyTemplate" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "SurveyAnswers_appointment_id_fkey" FOREIGN KEY ("appointment_id") REFERENCES "Appointment" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "sysdiagrams_principal_id_name_key" ON "sysdiagrams"("principal_id", "name");
